...
describe('CapsuleToggle', () => {
    ...
    describe('rendering', () => {
        it('should render the toggle with label', () => {
            render(<CapsuleToggle checked={false} onChange={mockOnChange} label="Test Label" />);
        ...
        it('should use custom testId when provided', () => {
            render(<CapsuleToggle checked={false} onChange={mockOnChange} label="Test Label" testId="custom-toggle" />);
    ...
    describe('checked state', () => {
        ...
        it('should show checked state when checked is true', () => {
            render(<CapsuleToggle checked={true} onChange={mockOnChange} label="Test Label" />);
    ...
    describe('disabled state', () => {
        it('should not call onChange when clicked while disabled', () => {
            render(<CapsuleToggle checked={false} onChange={mockOnChange} label="Test Label" disabled={true} />);
    ...
    describe('accessibility', () => {
        ...
        it('should be associated with label via aria-labelledby', () => {
            render(<CapsuleToggle checked={false} onChange={mockOnChange} label="Test Label" testId="my-toggle" />);
